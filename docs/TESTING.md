...
- Continuity artifacts exist: `briefs/state/continuity_last7d.md`, `briefs/state/active_narratives.yml`.
...
## Test 2 — State file overwrite
1) Run Task 1 twice on different days.
2) Confirm `briefs/state/continuity_last7d.md` and `briefs/state/active_narratives.yml` are overwritten (latest date), while `briefs/daily/YYYY-MM-DD.md` remains immutable.
